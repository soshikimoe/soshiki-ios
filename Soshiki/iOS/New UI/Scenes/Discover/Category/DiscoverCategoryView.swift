...
class DiscoverCategoryView: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let item = NSCollectionLayoutItem(
            layoutSize: NSCollectionLayoutSize(
                widthDimension: .absolute(120 + 16),
    ...
    func setTitle(to title: String) {
        self.title = title
        self.headerView.setTitle(to: title)
    }
    ...
    func configureDataSource() -> UICollectionViewDiffableDataSource<Int, SourceEntry> {
        let cellRegistration = UICollectionView.CellRegistration<SourceEntryCollectionViewCell, SourceEntry> { cell, _, entry in
...
// MARK: - DiscoverCategoryView + UICollectionViewDelegate

extension DiscoverCategoryView: UICollectionViewDelegate {
